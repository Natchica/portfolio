...
export const PoneglyphAlphabetSection: React.FC = () => {
  // Define all symbols with their paths and labels
      ...
      <div className="max-w-7xl w-full">
        ...
        <div className="mt-16 text-center">
          <p className="text-stone-400 text-sm max-w-2xl mx-auto">
            This ancient script serves as a visual representation of blockchain
            principles throughout this portfolio — immutability meets artistry.
          </p>
        </div>
      </div>
    </section>
